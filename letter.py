...
class Letter():
    ...
    def getCoordinates(self):
        ...
        if ((self.getLetter() == 'A') | (self.getLetter() == 'Q')):
            self.column = 1
        if ((self.getLetter() == 'Z') | (self.getLetter() == 'S') ):
            self.column = 2
        if ((self.getLetter() == 'E') | (self.getLetter() == 'D') | (self.getLetter() == 'W')):
            self.column = 3
        if ((self.getLetter() == 'R') | (self.getLetter() == 'F') | (self.getLetter() == 'X')):
            self.column = 4
        if ((self.getLetter() == 'T') | (self.getLetter() == 'G') | (self.getLetter() == 'C')):
            self.column = 5
        if ((self.getLetter() == 'Y') | (self.getLetter() == 'H') | (self.getLetter() == 'V')):
            self.column = 6
        if ((self.getLetter() == 'U') | (self.getLetter() == 'J') | (self.getLetter() == 'B')):
            self.column = 7
        if ((self.getLetter() == 'I') | (self.getLetter() == 'K') | (self.getLetter() == 'N')):
            self.column = 8
